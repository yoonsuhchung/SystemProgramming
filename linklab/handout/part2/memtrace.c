...
void *realloc(void* ptr, size_t size){
  ...
  newptr=reallocp(ptr, size); //real realloc.. free is included. just count.
  //in realloc, don't free the original memory explicitly but just count it as freed memory.
...
// just count how much memory is freed in reallocp.
void realloc_free(void* ptr){
  item* freed_ptr;
